...
function set_styles(back, front, position) {
  ...
  back.style.top = front.offsetTop
  back.style.left = front.offsetLeft
  back.style.height = front.offsetHeight
  back.style['min-height'] = front.offsetHeight
  back.style.width = front.offsetWidth
